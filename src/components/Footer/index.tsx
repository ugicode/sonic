...
const Footer = ({ data }) => {
  ...
  return (
    <>
      <footer className="relative z-10 bg-blue pt-16 dark:bg-gray-dark md:pt-20 lg:pt-24">
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="lg:w-12/12 md:w-2/2 w-full px-4 xl:w-7/12">
            ...
            <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-6/12 xl:w-2/12">
              <div className="mb-12 lg:mb-16">
